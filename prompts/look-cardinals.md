Create one horizontal four-cardinal anchor strip for Codex pet `bone-horn-sorceress`.

Use the attached canonical base, completed standard contact sheet, and layout guide for exact identity, style, scale, baseline, face construction, materials, palette, markings, props, and spacing. Read `docs/look-mechanics.md` and use the pet's natural gaze mechanism.
